...
//            s3client.putObject(new PutObjectRequest(bucketName, urlLogPathReturn + fileName, file));
    ...
    private static void getProperties() {
        ...
        try {
            propFile1 = new FileInputStream(System.getProperty("user.dir") + "/resources/aws.properties");
    ...
    public static void main(String[] args) {
        uploadFileToS3("AND_LoginTest_0-23-06-2023.png", "/Users/SBH/Documents/AutoApp/test-output/img/AND_LoginTest_0-23-06-2023.png");
        Log.addLog("url: " + getFileFromS3("AND_LoginTest_0-23-06-2023.png"));

//        Properties prop = new Properties();
//        FileInputStream propFile1 = null;
//        try {
//            propFile1 = new FileInputStream(System.getProperty("user.dir") + "/resources/awsUploadJAR.properties");
//        } catch (FileNotFoundException e) {
//            e.printStackTrace();
//        }
//        try {
